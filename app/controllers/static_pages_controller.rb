 ...
 #    	end
  ...
  def sms
    ...
    # render :nothing => true
          ...
          # The Message   
          mobile_number = '19541112222'       # Use comma separated numbers to send the same text message to multiple numbers.
          ...
          # Get the response
          # response = RestClient.get 'http://api.clickatell.com/http/sendmsg?user=rresnick&password=dVAJOFRILWdfGe&api_id=3543539&to=19546614509&text=HallowWorld&mo=1&from=13054000747'
